        ...
        <div className="space-y-6">
            {
                items.map((item) => (
                    <div
                        ...
                        className="flex items-center gap-5 p-5 bg-gradient-to-br from-[#fff7ec] 
                        via-[#ffe5dc] to-[#fce4ec] rounded-2xl shadow-md hover:shadow-xl transition 
                        duration-300 border border-orange-100"
                    >
                        {/*image */}
                        <img
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                            ...
                            <p className="text-sm text-grey-700 mt-l">
